    ...
    if (p_buf != NULL)
    {
        ...
        switch (hw_cfg_cb.state)
        {
            ...
            case HW_CFG_DL_FW_PRE_PATCH:
                ALOGI("bt vendor lib: download fw pre patch");
            ...
            case HW_CFG_DL_FW_PATCH:
                ALOGI("bt vendor lib: download fw patch");
            ...
            case HW_CFG_START:
                ALOGI("bt vendor lib: hw cfg start");
            ...
            case HW_CFG_SET_UART_CLOCK:
                ALOGI("bt vendor lib: set uart clock");
            ...
            case HW_CFG_SET_UART_BAUD_2:
                /* update baud rate of host's UART port */
                ALOGI("bt vendor lib: set UART baud 2 %i", UART_TARGET_BAUD_RATE);
                userial_vendor_set_baud( \
                    line_speed_to_userial_baud(UART_TARGET_BAUD_RATE) \
                );
            ...
            case HW_CFG_READ_BD_ADDR:
                ALOGI("bt vendor lib: read bd addr");
