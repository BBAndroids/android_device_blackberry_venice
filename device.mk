...
# Bluetooth
PRODUCT_PACKAGES += \
    android.hardware.bluetooth@1.0-impl-venice \
    libbt-vendor

# Bluetooth firmware
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/bluetooth/BCM4356A2_001.003.015.0071.0204.hcd:$(TARGET_COPY_OUT_VENDOR)/firmware/BCM4356A2_001.003.015.0071.0204.hcd \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/input/stmpe_keypad.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/stmpe_keypad.idc \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/wifi/cfg_venice.ini:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/cfg_venice.ini \
    $(LOCAL_PATH)/wifi/cfg_venice_v6.ini:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/cfg_venice_v6.ini
